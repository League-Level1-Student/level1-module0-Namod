...
public class DrumKit implements MouseListener {
	...
	public void run() throws MalformedURLException {
		...
		String URL = "drum.jpg";
		String URL2 = "drum2.jpg";
		// 9. Edit the next line to use your String variable
		// drumLabelWithImage = createLabelImage(drumImageString);
		drumLabelWithImage = createLabelImage(URL);
		drumLabelWithImage2 = createLabelImage(URL2);
		// 10. Add the image to the panel
		object2.add(drumLabelWithImage);
		object2.add(drumLabelWithImage2);

		// 11. Set the layout of the panel to "new GridLayout()"
		object2.equals(new GridLayout());
	...
	public void mouseClicked(MouseEvent e) {
		...
		String	drum ="drumsound.wav";
		String drum1 = "drum.wav";
		String drum2 = "cymbal.wav";
